...
Ap3Geometry::Ap3Geometry(const std::string & name, H5::H5File & mpo_file) : name(name) {
    if (name.empty()) {
...
Ap3EnergyMesh::Ap3EnergyMesh(const std::string & name, H5::H5File & mpo_file) : name(name) {
    if (name.empty()) {
...
Ap3StateParam::Ap3StateParam(H5::H5File & mpo_file) {
...
Ap3Isotope::Ap3Isotope(const std::string & name, H5::H5File & mpo_file) : name(name) {
    if (this->name.empty()) {
...
Ap3Reaction::Ap3Reaction(const std::string & name, H5::H5File & mpo_file) : name(name) {
    if (this->name.empty()) {
