 ...
 */
void construct_coeff_gpu(double * coeff, const grid::CartesianGrid * p_grid, const Index * p_method,
...
__cuhostdev__ void recursive_interpolate(const double * coeff, const std::uint64_t & num_coeff,
                                         ...
                                         const Index & method, const std::uint64_t & ndim) noexcept;
 ...
 *  @param stream_ptr Pointer to the CUDA stream performing this calculation.
 */
void eval_intpl_gpu(double * coeff, const grid::CartesianGrid * p_grid, const Index * p_method, double * points,
