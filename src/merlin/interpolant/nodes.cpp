...
#include "merlin/interpolant/nodes.hpp"
...
Vector<double> interpolant::linspace_nodes(const double & xmin, const double & xmax, const std::uint64_t & n_point) {
...
// Chebyshev nodes
Vector<double> interpolant::chebyshev_nodes(const double & xmin, const double & xmax, const std::uint64_t & n_point) {
