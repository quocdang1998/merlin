...
class intpl::RegularGrid : public intpl::Grid {
  public:
    /// @name Constructor
    /// @{
    ...
    MERLIN_EXPORTS RegularGrid(const intpl::RegularGrid & src);
    /** @brief Copy assignment.*/
    MERLIN_EXPORTS intpl::RegularGrid & operator=(const intpl::RegularGrid & src);
    /** @brief Move constructor.*/
    MERLIN_EXPORTS RegularGrid(intpl::RegularGrid && src);
    /** @brief Move assignment.*/
    MERLIN_EXPORTS intpl::RegularGrid & operator=(intpl::RegularGrid && src);
    /// @}
  ...
  protected:
    ...
    /** @brief Begin iterator.*/
    intpl::RegularGrid::iterator begin_;
    /** @brief End iterator.*/
    intpl::RegularGrid::iterator end_;
};

}  // namespace merlin

#endif  // MERLIN_INTPL_REGULAR_GRID_HPP_
