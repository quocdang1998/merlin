...
#ifndef MERLIN_INTPL_SPARSE_GRID_HPP_
 ...
 */
class intpl::SparseGrid : public intpl::Grid {
  public:
    /// @name Constructor
    /// @{
    ...
    MERLIN_EXPORTS SparseGrid(const intpl::SparseGrid & src);
    /** @brief Copy assignment.*/
    MERLIN_EXPORTS intpl::SparseGrid & operator=(const intpl::SparseGrid & src);
    /** @brief Move constructor.*/
    MERLIN_EXPORTS SparseGrid(intpl::SparseGrid && src);
    /** @brief Move assignment.*/
    MERLIN_EXPORTS intpl::SparseGrid & operator=(intpl::SparseGrid && src);
    /// @}
...
#endif  // MERLIN_INTPL_SPARSE_GRID_HPP_
