...
__global__ void print_grid_from_shared_mem(merlin::interpolant::CartesianGrid * grid_ptr) {
    CUDAOUT("Cartesian Grid on GPU (shared mem):\n");
    extern __shared__ merlin::interpolant::CartesianGrid share_ptr[];
...
__global__ void print_grid(merlin::interpolant::CartesianGrid * grid_ptr) {
