...
int main(void) {
    ...
    // coeff 1
    merlin::array::Array coeff_1 = merlin::calc_lagrange_coeffs_cpu(&grid, &value_1, slice_1);
    ...
    // coeff 2
    merlin::array::Array coeff_2 = merlin::calc_lagrange_coeffs_cpu(&grid, &value_2, slice_2);
